...
use Mikron\HubFront\Infrastructure\Security\AuthenticationTokenSimple;
...
class AuthenticationTokenSimpleTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('\Mikron\HubFront\Domain\Exception\AuthenticationException');
